...
class AutoPublisherTestCase(CMSTestCase, TestCase):
    ...
    def test_save_page(self):
        ...
        # TODO: this isnt working yet!? normaly, a page is saved with a title.
        # works via frontend, though!?
    ...
    def test_add_save_plugin(self):
        ...
        plugin.save()
        # TODO: inconsistency, publish should not be needed, but appearently,
        # dirty state is not applied when saving a plugin with save() only.
        page.publish("en")
        response = self.client.get(page.get_absolute_url())
    ...
    def test_move_plugin(self):
        ...
        plugin2 = cms_api.add_plugin(
            placeholder, TestPlugin, "en", field1="teststring2"
        )
